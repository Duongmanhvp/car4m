    ...
    return (
        <div className='bg-whitesmoke w-full flex flex-col font-baloo-2 px-2 gap-2'>
            <div className='text-xxl text-left flex flex-row items-center justify-between w-full'>
                ...
                <div className="w-[150px] h-[40px] flex flex-row items-center justify-between gap-2">
                    <div className="w-1/2 h-[40px] gap-1 cursor-pointer rounded-lg flex flex-row items-center justify-center text-base text-white bg-green-500">
                        <a onClick={() => acceptCar()} className="leading-[150%] flex items-center justify-center shrink-0">Thêm</a>
                        <Image className="w-4 relative h-4" alt="" src={tick} />
                    </div>
                    <div className="w-1/2 h-[40px] gap-1 cursor-pointer rounded-lg flex flex-row items-center justify-center text-base text-white bg-red">
                        <a onClick={() => rejectCar()} className="leading-[150%] flex items-center justify-center shrink-0">Xóa</a>
                        <Image className="w-4 relative h-4" alt="" src={close} />
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center bg-whitesmoke font-baloo-2 gap-2 p-2">
                {items.map((item) =>
                (<div className='cursor-pointer w-[720px] rounded-xl border border-smoke'>
                    <div className="rounded-xl bg-white p-2 flex flex-row items-start justify-between text-left text-base text-gray gap-3">
                        ...
                        <div className="flex flex-col pt-3 gap-4 w-full">
                            <div className="flex flex-col items-start justify-start gap-3">
                                ...
                                <div onClick={() => handleInfoCar(item.id)}  className="flex flex-row items-center justify-start gap-1.5 text-xs">
                                ...
                                <div onClick={() => handleInfoCar(item.id)}  className="flex flex-row items-center justify-between gap-2">
                            ...
                            <div onClick={() => handleInfoCar(item.id)}  className="flex flex-row items-center justify-between w-full text-dimgray border-t border-line pt-4 pr-1">
